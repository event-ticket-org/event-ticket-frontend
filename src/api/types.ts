...
export type OrganizationOwner = Schemas['OrganizationOwner']
export type OrganizationStatus = Schemas['OrganizationStatus']
export type OrganizationPage = Schemas['OrganizationPage']
export type OrganizationDecisionRequest = Schemas['OrganizationDecisionRequest']
...
export type PricingTierInput = Schemas['PricingTierInput']
export type EventPage = Schemas['EventPage']
export type CoverImageSize = Schemas['CoverImageSize']
export type CoverUpload = Schemas['CoverUpload']
export type CoverConfirmation = Schemas['CoverConfirmation']
export type Category = Schemas['Category']
export type City = Schemas['City']
export type CategoryFacet = Schemas['CategoryFacet']
export type TrendingEvent = Schemas['TrendingEvent']
export type FeaturedSlot = Schemas['FeaturedSlot']
export type FeaturedSlotInput = Schemas['FeaturedSlotInput']
